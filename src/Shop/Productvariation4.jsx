...
import shoes from "../assets/productvar4/asset 3.png";
import first from "../assets/productvar4/asset 13.png";
import second from "../assets/productvar4/asset 8.png";
import third from "../assets/productvar4/asset 9.png";
import four from "../assets/productvar4/asset 10.png";
import five from "../assets/productvar4/asset 11.png";
import six from "../assets/productvar4/asset 12.png";
import easy from "../assets/productvar4/asset 14.png";
import service from "../assets/productvar4/asset 15.png";
import product from "../assets/productvar4/asset 16.png";
import { Footer } from "../Home/Footer";

export const Productvariation4 = () => {
  return (
    <>
      <div>
        <Topnavbar />
          ...
          <div className="grid grid-cols-2 gap-10 py-[80px] px-[120px]">
            <div className="main-div-photos">
              <div className="relative ">
                ...
                <div>
                  <div>
                    <img className="rounded-lg" src={shoes} alt="" />
                  </div>
                </div>
              </div>
              <div>
            ...
            <div className="main-div-details ">
              ...
              <div>
                ...
                <div className="flex">
                  ...
                  <div className="mr-10">
                    <div className="flex justify-center items-center h-16 w-16 bg-white rounded-full mb-5">
                      <img className="h-8" src={service} alt="" />
                    </div>
                    <h1 className="font-semibold text-xl text-[#292930]">
                      Quality Service
                    </h1>
                  ...
                  <div>
                    <div className="flex justify-center items-center h-16 w-16 bg-white rounded-full mb-5">
                      <img className="h-8" src={product} alt="" />
                    </div>
                    <h1 className="font-semibold text-xl text-[#292930]">
                      Original Product
                    </h1>
